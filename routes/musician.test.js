...
const store = require('../../../Downloads/musician-app-master/musician-app-master/store/datastore');
const initialStoreData = require('../../../Downloads/musician-app-master/musician-app-master/store/data');
...
beforeEach(() => {
  server = require('../../../Downloads/musician-app-master/musician-app-master');
});
